...
class DungeonFactory:
    ...
    ROOM_0_1_EXIT_EASY = [
        ...
        ['D', 'F', 'F', 'F', 'F', 'F', 'R', 'F', 'F', 'B', 'F', 'F', 'F', 'D'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'R', 'F', 'F', 'B', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'R', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'B', 'D', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B'],
    ]
