...
class DungeonFactory:
    ...
    ROOM_0_0_ENTRY_EASY = [
        ...
        ['B', 'F', 'p', 'p', 'R', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'p', 'p', 'R', 'F', 'F', 'F', 'F', 'F', 'A', 'F', 'F', 'D'],
        ['B', 'F', 'F', 'F', 'R', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
    ...
    ROOM_1_0_EASY = [
        ...
        ['B', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['D', 'F', 'F', 'F', 'F', 'F', 'E', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'p', 'F', 'R', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'p', 'F', 'F', 'F', 'F', 'F', 'F', 'R', 'R', 'R', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'B', 'D', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B'],
    ]
    ...
    ROOM_0_1_EXIT_EASY = [
        ...
        ['B', 'F', 'p', 'F', 'I', 'F', 'R', 'F', 'F', 'B', 'F', 'F', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'R', 'F', 'F', 'F', 'F', 'p', 'F', 'B'],
        ['B', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'B'],
        ['B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B'],
    ]
